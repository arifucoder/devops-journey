...
![ISP থেকে Modem, তারপর Device ও Port](images/01-isp-modem-port-flow.png)
...
> ⚠️ **বানান ঠিক করা হলো:** এটা "DCP" নয় — **DHCP** (মাঝে একটা **H** আছে)।
...
![Common Network Ports](images/02-common-network-ports.png)
...
![Types of Network Topologies](images/03-network-topologies.png)
...
![OSI Model Layers](images/04-osi-model-layers.png)
...
![OSI Model Real-Life Examples](images/06-osi-real-life-example.png)
...
![OSI Encapsulation Flow](images/05-osi-encapsulation-flow.png)
...
![Subnet Mask](images/07-subnet-mask.png)
...
![CIDR Calculator](images/09-cidr-calculator.png)
...
![AWS VPC with Public and Private Subnet](images/08-aws-vpc-subnet.png)
